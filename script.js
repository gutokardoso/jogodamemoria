...
function reset(){score=0;pairs=0;time=TIMER_TOTAL;lastMatchTime=TIMER_TOTAL;flipped=[];lock=false;canPlay=false;timerEl.textContent=TIMER_TOTAL+'s';timerEl.style.color='';scoreEl.textContent='0000';pairsEl.textContent='0/8';clearInterval(timerId);updateTimerRing();buildBoard()}
